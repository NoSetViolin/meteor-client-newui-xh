...
public class MeteorGuiTheme extends GuiTheme {
    ...
    public final Setting<Boolean> modernLightMode = sgGeneral.add(new BoolSetting.Builder()
        .name("modern-light-mode")
        .description("Uses the light Win11 Mica palette in the modern module browser.")
        .defaultValue(false)
        .onChanged(_ -> {
            if (mc.gui.screen() instanceof WidgetScreen widgetScreen) widgetScreen.invalidate();
        })
    ...
    public final ThreeStateColorSetting sliderHandle = new ThreeStateColorSetting(
        sgSlider,
        "slider-handle",
        new SettingColor(0, 220, 230),
        new SettingColor(0, 245, 255),
        new SettingColor(70, 250, 255)
    );

    public final Setting<SettingColor> sliderLeft = color(sgSlider, "slider-left", "Color of slider left part.", new SettingColor(0, 210, 220));
    ...
    public class ThreeStateColorSetting {
        ...
        public void set(SettingColor normal, SettingColor hovered, SettingColor pressed) {
